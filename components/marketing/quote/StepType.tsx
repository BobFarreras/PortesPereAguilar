...
import { DOOR_TYPES } from '@/lib/constants/quoteOptions';
...
export default function StepType({ selected, onSelect }: StepTypeProps) {
  const t = useTranslations('quote.steps.type');
        ...
        {DOOR_TYPES.map((type) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4">
              <span className={`text-lg font-semibold ${selected === type.id ? 'text-white' : 'text-white'}`}>
