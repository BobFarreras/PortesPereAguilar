...
import { AUTOMATION_DOORS } from '@/lib/constants/quoteOptions';
...
export default function StepAutomation({ selected, onSelect }: StepAutomationProps) {
  const t = useTranslations('quote.steps.automation');
        ...
        {AUTOMATION_DOORS.map((door) => (
          ...
          >
            ...
            <div className="relative w-full h-40 bg-gray-100 dark:bg-white/5">
              <Image
                src={door.imageUrl}
                alt={t(`options.${door.translationKey}`)}
                fill
